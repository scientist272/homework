package com.charlie.homework.util;
 ...
 * <p>
 * 2.  对这4段循环处理，取每段的8个字符, 将他看成16进制字符串与0x3fffffff(30位1)的位与操作，超过30位的忽略处理。多了也没用因为下面要分成6段  正好取整。注意用Long型变量
...
public class LongUrlConventor {
    public static String[] convert(String longUrl,String md5Key) {
...
// 对传入网址进行 MD5 加密
        String sMD5EncryptResult = DigestUtils.md5Hex(md5Key + longUrl);
